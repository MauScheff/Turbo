...
struct TurboTests {
    ...
    @MainActor
    @Test func prewarmedDirectQuicSystemTransmitBridgeStartsCaptureBeforeBackendLease() async {
        let viewModel = PTTViewModel()
        let contactID = UUID()
        let channelUUID = UUID()
        let mediaSession = RecordingMediaSession()
    ...
    @MainActor
    @Test func systemAudioActivationRefreshesPrewarmedDirectQuicCapture() async {
        let viewModel = PTTViewModel()
        let contactID = UUID()
        let channelUUID = UUID()
        let mediaSession = RecordingMediaSession()
    ...
    @MainActor
    @Test func foregroundIncomingAudioChunkWaitsForPTTAudioActivationBeforePlayback() async throws {
        let viewModel = PTTViewModel()
        let contactID = UUID()
        let channelUUID = UUID()
        viewModel.contacts = [
